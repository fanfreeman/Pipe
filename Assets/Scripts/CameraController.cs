...
public class CameraController : MonoBehaviour {
    ...
    private void Update()
    {
        ...
        if (progresses[NumDataPoints - 1] >= 1) currentPipes[NumDataPoints - 1] = pipeSystem.SetupNextPipe();
        ...
        for (int i = 1; i < NumDataPoints - 1; i++)
        {
            ...
            if (progresses[i] >= 1) currentPipes[i] = currentPipes[NumDataPoints - 1];
        }
        ...
        for (int i = 1; i < NumDataPoints; i++)
        {
            ...
            //centerTrackPointDirections[i] = currentPipes[i].GetCenterPointDirectionByProgressLocal(progresses[i]);
        }
    ...
    private void OnDrawGizmos()
    {
        if (Application.isPlaying)
        {
            ...
            Gizmos.DrawLine(centerTrackPointPositions[0], centerTrackPointPositions[0] + centerTrackPointDirections[0] * 6f);
        }
    }
}
